...
humandate: "Aug 4-7, 11-12, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
enddate: 2024-08-13        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Trisha Adamus", "Zekai Otles", "Sarah Stevens", "Erwin Lares", "Heather Shimon", "Grace Cagle"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Annika Pratt", "Trisha Adamus", "Zekai Otles", "Sarah Stevens", "Erwin Lares", "Heather Shimon", "Grace Cagle"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2024-08-05-uwmadison-dc # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
eventbrite:   927955679417        # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
{% if page.humandate %}
<p id="when">
  <strong>When:</strong> {{page.humandate}}; {{page.humantime}}
